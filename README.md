...
### 5. Research Galaxy에서 연구 관계를 탐색합니다
...
이 화면의 연구 그래프는 운영 사용자 컬렉션과 분리해 관리합니다.
검색어와 논문 텍스트의 관련도를 계산한 뒤 그래프 이웃을 확장하여 검색
경로를 보여줍니다. 현재 그래프 자체에서 LLM 답변을 생성하지는 않으며,
기존 AI 챗봇의 벡터 RAG와도 데이터를 분리합니다.
